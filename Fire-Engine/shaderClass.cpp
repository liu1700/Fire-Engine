...
bool ShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename, char* vsFuncname, char* psFuncname)
{
...
bool ShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
											 D3DXMATRIX projectionMatrix, ID3D11ShaderResourceView** textureArray, UINT numInTextureArray)
{
	...
	// 设定纹理资源
	deviceContext->PSSetShaderResources(0, numInTextureArray, textureArray);
